        ...
        <div className="main-container">
            ...
            <form onSubmit={formik.handleSubmit} className="flex flex-col items-center gap-y-4">
                ...
                <label className="flex-1 flex flex-col md:w-1/2 w-full">
                    ...
                    <input onBlur={formik.handleBlur} name="lastName" onChange={formik.handleChange} value={formik.values.lastName} className={`contact-input ${formik.errors.lastName && formik.touched.lastName && "dark:border-red-500 border-red-500"}`} type="text" placeholder="Soy İsim" />

                </label>
                <label className="flex-1 flex flex-col md:w-1/2 w-full">
                    {formik.errors.email && formik.touched.email && <p className="text-red-500 text-sm font-semibold">{formik.errors.email}</p>}
                    <input onBlur={formik.handleBlur} name="email" onChange={formik.handleChange} value={formik.values.email} className={`contact-input ${formik.errors.email && formik.touched.email && "dark:border-red-500 border-red-500"}`} type="email" placeholder="E-Mail" />
                ...
                <label className="md:w-1/2 w-full">
                    ...
                    <textarea onBlur={formik.handleBlur} name="message" onChange={formik.handleChange} value={formik.values.message} className={`contact-input ${formik.errors.message && formik.touched.message && "dark:border-red-500 border-red-500"} min-h-[200px] max-h-[200px] pt-1`} placeholder="Mesajınız..."></textarea>
                </label>
