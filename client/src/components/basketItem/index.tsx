    ...
    return (
        <div className="max-w-full w-full sm:flex-row flex-col flex justify-start border-2 rounded-md gap-x-6">
            ...
            <div className="p-2 flex-1 flex flex-col gap-y-[4px]">
                <Link to={`/shop/${item._id}`} className="text-base font-semibold text-veryDarkBlue">
            ...
            <div className='flex justify-between p-2'>
                ...
                <button onClick={() => removeFromBasket(item._id)} className='mx-4 text-2xl p-2 transition-all self-center hover:scale-[1.1] text-veryDarkBlue hover:text-primaryRed'>
